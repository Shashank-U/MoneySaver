                ...
                public void onClick(View view) {
                    ...
                    if (email1.isEmpty() || pw1.isEmpty() || name1.isEmpty() || pw2.isEmpty()) {
                       /* t = Toast.makeText(getApplicationContext(), "Fields cannot be empty", Toast.LENGTH_SHORT);
                        ...
                        Snackbar snackbar1 = Snackbar.make(findViewById(android.R.id.content), "Email id exists", Snackbar.LENGTH_LONG);
                        snackbar1.show();
                    }
                    else if (!(pw1.equals(pw2))) {
                       /* t = Toast.makeText(getApplicationContext(), "Passwords did not match", Toast.LENGTH_SHORT);
                        t.show();*/

                        Snackbar snackbar = Snackbar.make(findViewById(android.R.id.content), "Passwords did not match", Snackbar.LENGTH_LONG);
                        snackbar.show();
                    } else {
